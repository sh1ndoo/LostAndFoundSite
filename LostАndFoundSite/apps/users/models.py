...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    USERNAME_FIELD = 'phone_number'  # Устанавливаем телефон как поле для входа
    REQUIRED_FIELDS = []
...
class PhoneNumberOTP(models.Model):
    ...
    is_verified = models.BooleanField(default=False) # Флаг, был ли OTP использован
    ...
    def generate_otp(self):
        ...
        self.expires_at = timezone.now() + timezone.timedelta(minutes=5) # OTP действует 5 минут
        self.is_verified = False # Сброс флага при генерации нового OTP
        self.save()
